...
class MyAdvertisementsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_find_without_search, container, false)
        val fragment = AdvertisementsListFragment.newInstance(createParams("filter" to "user"), true)
